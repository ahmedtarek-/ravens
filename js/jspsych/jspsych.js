  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><p>Nach Klick auf den Knopf unten beginnt das Experiment im Vollbildmodus.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Experiment starten</button></div>');
